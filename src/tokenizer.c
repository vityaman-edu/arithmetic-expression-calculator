...
static const char *TOKENS[] = {
    ...
    [TOK_OPEN] = "(", [TOK_CLOSE] = ")", [TOK_LIT] = "",  [TOK_NEG] = "-"};

const char *TOKENS_STR[] = {
    [TOK_PLUS] = "PLUS",  [TOK_MINUS] = "MINUS", [TOK_MUL] = "MUL",
    [TOK_DIV] = "DIV",    [TOK_OPEN] = "OPEN",   [TOK_CLOSE] = "CLOSE",
    [TOK_LIT] = "LIT",    [TOK_NEG] = "NEG",     [TOK_END] = "END",
    [TOK_ERROR] = "ERROR"};
